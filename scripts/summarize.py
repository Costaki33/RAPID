...
Examples::
    ...
    python scripts/summarize.py --jsonl results/matrix.jsonl
    python scripts/summarize.py --jsonl results/matrix.jsonl --n-stations 228
    python scripts/summarize.py --jsonl results/matrix.jsonl --model PhaseNet --top 20
"""
