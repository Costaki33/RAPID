...
Examples::
    ...
    python benchmarks/fair/run_fair_scheduler.py --dry-run

    # Native-only, CPU grid + GPU, 5 repeats, 120-core machine
    python benchmarks/fair/run_fair_scheduler.py --family native --total-cpus 120
"""
...
def main() -> int:
    ...
    # run via --family oversub (see benchmarks/fair/run_oversub_sweep.sh).
