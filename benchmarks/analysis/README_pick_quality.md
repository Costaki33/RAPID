...
```bash
python benchmarks/analysis/analyze_pick_quality.py --jsonl-dir results/ --out-dir figures/pick_quality/
```
...
python benchmarks/analysis/run_pick_quality_analysis.py \
    --n-traces 50 \
    --dataset stead \
    --devices cpu cuda:0 \
...
```bash
python benchmarks/analysis/run_pick_quality_analysis.py --n-traces 2 --models pn --devices cuda:0 \
...
```bash
python research/paper/generate_pick_quality_figures.py \
